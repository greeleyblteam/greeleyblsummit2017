jQuery(document).ready(function($) {
   ...
   jQuery('.tp-banner').show().revolution(
    ...
    $('#countdown').countdown({until: new Date(2017, 11-1, 2),timezone: null,}); // enter event day
	...
	var latlng = new google.maps.LatLng(40.4266637,-104.6957928);
	...
	var marker1 = new google.maps.Marker({
		position: new google.maps.LatLng(40.4266637,-104.6957928),
		map: map,
	...
	var infowindow1 = new google.maps.InfoWindow({
		content:  createInfo('BL Summit', '919 7th St,<br />Greely, CO, 80634,<br />1-970-304-0000<br /><br />')
	});
