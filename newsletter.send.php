<?php
	...
	$send_name      = "Greeley BL Summit";		// Replace your name
	$send_title     = "Greeley BL Summit Newsletter";		// Replace email sent title
	$send_address   = "rfitzpatrick@greeleyschools.org";	// Replace your email address

	$smtp_address   = "rfitzpatrick@greeleyschools.org";		// Replace your email address
	$smtp_password	= "Swim1981";				// Replace your email password
	$smtp_server	= "mail.google.com";	// Replace your email server address
